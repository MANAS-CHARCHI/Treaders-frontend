...
export default function Login() {
    ...
    const handleGoogleSocialLogin = () => {
        window.location.href = "http://localhost:5001/auth/google/login/google-oauth2/";
    };
    ...
    return (
        <div style={{ maxWidth: "400px", margin: "50px auto", textAlign: "center" }}>
            ...
            <button
                ...
                style={{ display: "block", width: "100%", padding: "10px", backgroundColor: "#4285F4", color: "white", border: "none", cursor: "pointer" }}
            >
                Login with Google
            </button>
        </div>
